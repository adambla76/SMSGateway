#
#
# SIM800L linux driver to GSM modem
...
class SIM800L:
    def __init__(self,_ser="/dev/serial0",_speed=38400):
        try:
            self.ser=serial.Serial(_ser, baudrate=_speed, timeout=1)
    ...
    def setup(self):
        ...
        self.command('AT+CNMI=1,1,0,1\n')
        self.command('AT+CSMP=17,167,2,25\n')    # enable get local timestamp mode
